...
/**
  ...
  H(s) = Kdc X --- X ------------
                s    Wz1(Wp2 + s)
                  ...
                  1.26e+02   9.45e+04(5.23e+03 + s)
  H(s) = 56.000 X -------- X ----------------------
                     s       5.23e+03(9.45e+04 + s)
  ...
  b0      0.590     0.509         16684    0x412C
  b1      0.046     0.039         1289     0x0509
  b2      -0.544    -0.470        -15394   0xC3DE
...
#define FM_COMP_2P2Z_COEFF_A1      0x7FFC
#define FM_COMP_2P2Z_COEFF_A2      0xEE8D
#define FM_COMP_2P2Z_COEFF_B0      0x412C
#define FM_COMP_2P2Z_COEFF_B1      0x0509
#define FM_COMP_2P2Z_COEFF_B2      0xC3DE
#define FM_COMP_2P2Z_POSTSCALER    0x4A1C
#define FM_COMP_2P2Z_POSTSHIFT     0xFFFF
#define FM_COMP_2P2Z_PRESHIFT      0x0000


// Compensator Clamp Limits
#define FM_COMP_2P2Z_MIN_CLAMP    0x0000
#define FM_COMP_2P2Z_MAX_CLAMP    0x4E20
