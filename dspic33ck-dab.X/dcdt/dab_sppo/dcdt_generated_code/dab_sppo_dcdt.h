/**
  ...
  File Name:     dab_sppo_dcdt.h
  Project Name:  dab_sppo
  Date:          1/16/2025
  Time:          20:50.34
 ...
 **/
#ifndef _DAB_SPPO_DCDT_DEFINES_H
#define _DAB_SPPO_DCDT_DEFINES_H
...
#define DAB_SPPO_COMP_2P2Z_COEFF_A1      0x7FFC
#define DAB_SPPO_COMP_2P2Z_COEFF_A2      0xDF2B
#define DAB_SPPO_COMP_2P2Z_COEFF_B0      0x3BE5
#define DAB_SPPO_COMP_2P2Z_COEFF_B1      0x02EF
#define DAB_SPPO_COMP_2P2Z_COEFF_B2      0xC70B
#define DAB_SPPO_COMP_2P2Z_POSTSCALER    0x5617
#define DAB_SPPO_COMP_2P2Z_POSTSHIFT     0xFFFF
#define DAB_SPPO_COMP_2P2Z_PRESHIFT      0x0000


// Compensator Clamp Limits
#define DAB_SPPO_COMP_2P2Z_MIN_CLAMP    0x0000
#define DAB_SPPO_COMP_2P2Z_MAX_CLAMP    0x7FFF
