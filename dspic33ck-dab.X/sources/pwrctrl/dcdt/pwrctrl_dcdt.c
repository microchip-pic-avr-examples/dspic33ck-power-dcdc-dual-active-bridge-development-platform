 ...
 *  There are dedicated instances for Forward mode and Reverse mode:
 *  PSVO Primary to Secondary V Output
 *  SPVO Secondary to Primary V Output
 *********************************************************************************/
void PwrCtrl_VComp_Initialize(void)
{
  //charger direction, PSVO,   Primary to Secondary V Out loop  
  ...
  SMPS_Controller2P2ZInitialize(&VMC_2p2z);  
    ...
    //discharger direction, SPVO,   Secondary to Primary V Out loop
 ...
 *  There are dedicated instances for Forward mode and Reverse mode:
 *  PSIO Primary to Secondary I Output
 *  SPIO Secondary to Primary I Output
 *********************************************************************************/
void PwrCtrl_IComp_Initialize(void)
{
   //charger, PSIO,   Primary to Secondary I Out loop
  ...
  //explicit clear to 0
   ...
   //discharger, SPIO,   Secondary to Primary I Out loop
 ...
 *  There are dedicated instances for Forward mode and Reverse mode:
 *  PSPO Primary to Secondary Power Output
 *  SPPO Secondary to Primary Power Output
 *********************************************************************************/
void PwrCtrl_PComp_Initialize(void)  //only battery has power sense option. should be bidirectional
{
    //charger, PSPO,   Primary to Secondary Power Out loop
   ...
   //discharger, SPPO,   Primary to Secondary Power Out loop
