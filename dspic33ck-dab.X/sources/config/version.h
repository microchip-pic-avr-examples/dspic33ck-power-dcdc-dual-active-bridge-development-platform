...
//#define FIRMWARE_VERSION_REVISION (0x0004) //minimum phase clamping lim increased due to glitch on startup.  Transformer Fault OC handling improved 
//#define FIRMWARE_VERSION_REVISION (0x0005)   //cleanup, comments, macros
#define FIRMWARE_VERSION_REVISION (0x0006)   //warning cleanup
 ...
 **********************************************************************************/
#define FIRMWARE_VERSION_STRING "00.01.0006" 
/*********************************************************************************
 * @ingroup apps-layer-properties-public-defines
