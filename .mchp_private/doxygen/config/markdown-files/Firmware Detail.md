...
- The current transformer in the secondary voltage bridge sense is connected to CMP1DAC.
- The current transformer in the primary voltage bridge sense is connected to CMP3DAC.
